    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
            ...
            <div>
              ...
              >
                ...
                <p className="text-[16px] mb-4 text-justify">
                  ...
                  <strong>cantinho dedicado ao café</strong>. Ambiente climatizado e totalmente funcional, acomoda{" "}
                  <strong>até 6 pessoas com conforto</strong>, com lotação máxima de {" "}
                  <strong>8 pessoas</strong>, pronta para o seu time começar a operar imediatamente.
                </p>
          ...
          >
            👉 <strong>Atenção:</strong> qualquer personalização deve ser avaliada previamente. Consulte com a nossa equipe para verificar as{" "}
